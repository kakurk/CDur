...
ggsave('~/Documents/MATLAB/githubrepos/personal-repos/CDur/figures/Figure3.png', 
      dpi = 300, 
      width = 7,
      height = 5,
      units = 'in')
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggsave('~/Documents/MATLAB/githubrepos/personal-repos/CDur/figures/Figure5.png', 
      dpi = 300, 
      width = 7,
      height = 5,
      units = 'in')
...
ggplot(EMMEANS.at.CovLevels, aes(x = enctype, y = emmean, ymax = upper.CL, ymin = lower.CL, fill = enctype)) +
  geom_col() +
  scale_fill_brewer(palette = "Set2") + 
  geom_errorbar(width = .2) +
  facet_grid(~composite, labeller = label_both) +
  labs(title = 'Directed Forgetting in Older Adults',
...
```{r, echo=FALSE, message=FALSE, warning=FALSE}
ggsave('~/Documents/MATLAB/githubrepos/personal-repos/CDur/figures/Figure4.png', 
      dpi = 300, 
      width = 7,
      height = 5,
      units = 'in')
